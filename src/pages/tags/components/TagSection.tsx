...
export function TagSection({ title, category, tags, onDeleteTag, onEditTag }: TagSectionProps) {
  return (
    <div className='mb-8'>
      ...
      <div className='grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4'>
        ...
        {tags.length === 0 && (
          <div className='col-span-full py-12 text-center text-warmGray-400 bg-white/50 rounded-2xl border-2 border-dashed border-cream-300'>
