...
import type { Tag, TagCategory, TagColor } from '@/types/tags'
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className='sm:max-w-md bg-white border-honey-200 rounded-2xl'>
        <DialogHeader>
          <DialogTitle className='text-2xl font-bold text-warmGray-800'>添加新便签</DialogTitle>
          <DialogDescription>创建一个新的分类便签</DialogDescription>
        </DialogHeader>
